...
* run.sh
    Run all configurations, vary parameters and compare
* REPORT_00195734.docx, REPORT_00195734.pdf
    Report, also submitted via turnitin
...
Unzip and place all python files in the same folder.
Unzip the data directory in the same folder.
Navigate to the folder, and run using
./TSP_00195734.py if under linux
or python3 -OO TSP_00195734.py under OSX

To replot the saved graphs, run the following
tar -xvjf plotted.tar.bz2

Then run the following command:
python3 plotagain.py /path/under/plotted/to/<filename-for-saved-plot>.pickle
